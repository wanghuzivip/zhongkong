...
<body>
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tr class="info">
			<th>用户名:</th>
			<td><input type="text" name="loginname" id="loginname" class="input_txt" value="${user.loginname }"/>
			<input type="hidden" name="password" id="password" class="input_txt"/>
			</td>
		</tr>
		<tr class="info">
			<th>名　称:</th>
		...
		<tr class="info">
			<th>部门:</th>
			<td><input type="text" name="department" id="department" class="input_txt" value="选择部门"/></td>
		</tr>
		<tr class="info">
			<th>角　色:</th>
			<td>
